   ...
   try:
      if(rel=='subdomains'):
         ...
         for i in range(len(dns_words)):
            base_url.append('https://api.securitytrails.com/v1/history/hilton.com/dns/'+dns_words[i]+'?apikey='+apkey)
         out_form = 'js'
...
if __name__=='__main__':
   ...
   # https://api.securitytrails.com/v1/history/hilton.com/dns/(dns rec names - cname is not accepted)?apikey=dQW6ZqfkR9HUZlo1MMX5RYMX7cgkFl0f
   # https://api.securitytrails.com/v1/domain/hilton.com/subdomains?apikey=dQW6ZqfkR9HUZlo1MMX5RYMX7cgkFl0f
   # https://api.securitytrails.com/v1/domain/hilton.com?apikey=dQW6ZqfkR9HUZlo1MMX5RYMX7cgkFl0f
   # https://api.securitytrails.com/v1/ips/nearby/167.187.200.23?apikey=dQW6ZqfkR9HUZlo1MMX5RYMX7cgkFl0f
   # https://api.securitytrails.com/v1/history/hilton.com/whois?apikey=dQW6ZqfkR9HUZlo1MMX5RYMX7cgkFl0f
   # https://api.securitytrails.com/v1/domain/hilton.com/associated?apikey=dQW6ZqfkR9HUZlo1MMX5RYMX7cgkFl0f
   # https://api.securitytrails.com/v1/ips/stats?ip=167.187.200.23&apikey=dQW6ZqfkR9HUZlo1MMX5RYMX7cgkFl0f
   # https://api.securitytrails.com/v1/ips/stats?ptr_part=hilton.com&apikey=dQW6ZqfkR9HUZlo1MMX5RYMX7cgkFl0f
